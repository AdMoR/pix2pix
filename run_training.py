...
train_data = torch.utils.data.DataLoader(my_dataset, batch_size=4, shuffle=True, num_workers=2)
gen = UNet([3, 64, 128, 256, 512, 512, 512, 512, 512]).to(device=device)
disc = EncoderNet([6, 64, 128, 256, 512, 512, 512]).to(device=device)
